...
def process_geojson(input_data, output_dir= "/Users/stephensmathew/cdl_rep/flood-data-ecosystem-Bihar/Sources/WORLDPOP/data/scraper/shapefiles/district_geojson"):
    """
...
def main():
    try:
        process_geojson(
         "/Users/stephensmathew/cdl_rep/flood-data-ecosystem-Bihar/Maps/br-ids-drr_shapefile/Bihar_subdistrict_final_4326.geojson")
