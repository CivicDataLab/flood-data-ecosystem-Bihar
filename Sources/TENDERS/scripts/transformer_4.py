...
data_path=r'D:\CDL\flood-data-ecosystem-Bihar\Sources\TENDERS\data'
od_gdf = gpd.read_file(r'D:\CDL\flood-data-ecosystem-Bihar\Maps\br-ids-drr_shapefile\Bihar_Subdistrict_final_simplified.geojson')
