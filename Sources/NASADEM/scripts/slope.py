...
dem_path = os.getcwd()+"/Sources/NASADEM/data/Bihar_NASADEM_DEM_30.tif"
...
#calculating slope using gradient function 
...
with rasterio.open(os.getcwd()+ "/Sources/NASADEM/data/Bihar_NASADEM_SLOPE_30.tif", 'w', **meta) as dst:
